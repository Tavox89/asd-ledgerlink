...
4. Use `/companies/<slug>/verifications` to test the exact post-email lookup flow your online payment system will call with `reference`, `name`, or both, plus `amount + date`.
