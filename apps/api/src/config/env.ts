...
const envSchema = z.object({
  ...
  BINANCE_ALLOWED_RECEIVER_ID: z.string().default(''),
  BINANCE_RECV_WINDOW_MS: z.coerce.number().int().min(1000).max(60000).default(5000),
  BINANCE_VERIFIER_URL: z.string().url().or(z.literal('')).default(''),
  BINANCE_VERIFIER_TOKEN: z.string().default(''),
